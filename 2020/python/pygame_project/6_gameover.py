...
# 게임 종료 메시지 / Timeout, Missiong Complete, Game Over
...
while running:
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        for weapon_idx, weapon_val in enumerate(weapons):
            ...
            continue # 안쪽 for문의 조건이 맞지 않으면 continue. 바깥 for문 계속 수행
        break # 안쪽 for문에서 break문을 만나면 여기로 진입 가능. 2중 for문 탈출
